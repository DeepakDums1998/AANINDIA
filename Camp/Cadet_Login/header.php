      ...
      <div class="sidebar-nav navbar-collapse">
        ...
        <li>
          ...
          <ul class="nav nav-second-level">
            <li>
              <li>
                <a href="Cadet_course/coursedashboard.php"> <i class="fa fa-list-alt"></i> Module</a>
              </li>
            </li>
            <li>
              <li>
                <a href="Cadet_course/ViewGuidelines.php"><i class="fa fa-book"></i> Guidelines
                </a>
              </li>
            </li>
            <li>
              <li>
                <a href="Cadet_course/ViewGuidelines.php"><i class="fa fa-bar-chart"></i> Progress</a>
              </li>
            </li>
          </ul>
          </li>
        ...
        <li>
          <li class="nav-item">
            <a class="nav-link collapsed text-truncate" href="#submenu1" data-toggle="collapse" data-target="#submenu1"><i class="fa fa-money"></i> Fees <span class="fa arrow"></span>
          </a>
          <ul class="nav nav-second-level">
             <?php
