...
<div id="page-wrapper">
                  ...
                  <div class="panel-body">
                    <div class="row">
                     ...
                     <div class="col-lg-6">
                          ...
                          <button type="submit" name="btnupdate" class="btn btn-success">ADD GUIDELINE</button>
                        </div>
                      </div>
  ...
  $sql = "INSERT INTO tbl_guidelines(A_id,TITLE,Guidelines) VALUES ('{$_SESSION["ADMIN"]}','{$_POST['txttitle']}','{$_POST['guideline']}')";
