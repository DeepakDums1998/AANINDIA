                             ...
                             <div class="col-lg-2">
                                <div class="form-group">
                                   <select class="form-control" name="year" id="erid" onchange="clearsss(this.value)">
                                      <?php
                                        $query = "select * FROM year_master ORDER BY Y_CODE DESC";
                                        $rs = $con->query($query);
                                        while($row = $rs->fetch_assoc())
                                        {
                                          ?>
                                          <option value="<?php echo substr($row["Y_CODE"], 2); ?>"><?php echo substr($row["Y_CODE"], 2); ?></option>
                                          <?php
                                        }
                                       ?>
                                   </select>
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <div class="form-group" style="margin-bottom: 0px;">
                        <b><label id="idnext" name="idnext" style="color: red;font-size: 18px;margin-top: 10px;">Enrollment Form Number Is : <?php
                           $erno = "";
                           ...
                           ?></label>
                         <select class="form-control" style="float: right;width: 200px;margin-bottom: 0px;margin-top: 4px;" name="cu_year" id="cu_year">
                                    <?php 
                                      $query = "SELECT * FROM year_master WHERE  Y_STATUS = 2";
                                      $rs = $con->query($query);
                                      while($row = $rs->fetch_assoc())
                                      {
                                        ?>
                                    ...
                                    <div class="panel-body">
                                      ...
                                      <div class="col-lg-4">
                                         <div class="form-group">
                                            ...
                                            <input class="form-control" type="textbox" placeholder="Ex :- 1028" name="cdt_form_no" id="cdt_form_no" required="">
                                         </div>
                                      </div>
                                      <div class="col-lg-4">
                                         <div class="form-group">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-lg-3">
                                              <div class="form-group">
                                                ...
                                                <input type="checkbox" id="checkATC" name="checkcampyear"> <label>ATC Done</label>
                                              </div>
                                          </div>
                                          <div class="col-lg-3">
                                              <div class="form-group">
                                                <input type="radio" id="rdSTC" value="STC" name="rdcampyear" value="ATC"> <label> STC</label>
                                                <br/>
                                                <input type="checkbox" id="checkSTC" name="checkcampyear"> <label>STC Done</label>
                                              </div>
                                          </div>
                                          <div class="col-lg-3">
                                              <div class="form-group">
                                                <input type="radio" id="rdOTC" value="OTC" name="rdcampyear"> <label> OTC</label>
                                              </div>
                                          </div>
                                          <div class="col-lg-3">
                                              <div class="form-group">
                                      ...
                                      <div class="row">
                                        <div class="col-lg-3">
                                           <div class="form-group">
                                              ...
                                              <input  type="text"  class="form-control " name="txtreceiptno" id="recipt" placeholder="EX:-124561">
                                           </div>
                                        </div>
                                      </div>
                                    </div>
           ...
           <?php
              ...
              if (isset($_POST["btnsubmit"])) {
                  ...
                  if($status == 0)
                  {
                    ...
                    if($BDate == "")
                    {
                      $sql = "INSERT INTO enroll_master(enrollment_id, yoe, t_year,c_year, first_name, middle_name, last_name, std, form_no, address, city, mobile1, mobile2, blood_group, gender, birthdate, aadharcard_no, status, late_status, atc, stc, otc, date_time) VALUES ('".$enrol."','".explode("-", $_SESSION["erno"])[0]."',".$t_year.",'".$cu_year."','".$firstname."','".$middlename."','".$lastname."','".$std."','".$form_no ."','".$address."','".$city."','".$mo1."','".$mo2."','".$blood_group."','".$gen."',NULL,'".$aadhar."',1,1,".$atc.",".$stc.",".$otc.",'".$cenvertedTime."')";
                    }
                    else
                    {
                      $sql = "INSERT INTO enroll_master(enrollment_id, yoe, t_year,c_year, first_name, middle_name, last_name, std, form_no, address, city, mobile1, mobile2, blood_group, gender, birthdate, aadharcard_no, status, late_status, atc, stc, otc, date_time) VALUES ('".$enrol."','".explode("-", $_SESSION["erno"])[0]."',".$t_year.",'".$cu_year."','".$firstname."','".$middlename."','".$lastname."','".$std."','".$form_no ."','".$address."','".$city."','".$mo1."','".$mo2."','".$blood_group."','".$gen."','".$BDate."','".$aadhar."',1,1,".$atc.",".$stc.",".$otc.",'".$cenvertedTime."')";
                    }
                    
                    if ($con->query($sql) == TRUE) {
                        /*  if(isset($_POST['txtreceiptno']))
                          {
                            $e_idquery="SELECT * FROM enroll_master where enrollment_id='{$_SESSION["erno"]}'";
                            $e_id=$con->query($e_idquery)->fetch_assoc()['e_id'];
                            $feesamount="SELECT * FROM tbl_feesstucture where t_year=1";
                            $f_amount=$con->query($feesamount)->fetch_assoc()['amount'];
                            $year=date("Y");
                            $insertreciept="INSERT INTO fees_payment(payment_id,e_id,amount,recipt_id,year,fees_for_year,P_status) VALUES('{$_POST['txtreceiptno']}',{$e_id},{$f_amount},'{$year}',1,1)";
                            if($con->query($insertreciept) == TRUE)
                            {
                              echo "<script>alert('fees Updated');</script>";
                            } 

                          }*/
                        $sql1 = "insert into activity_log_master(user_id,action_user_id,Status,Date_Time) values(".$_SESSION["ADMIN"].",'".$_SESSION["erno"]."',1,'".date('Y-m-d H:i:s')."')";
                        $con->query($sql1);
                      $sql23 = "select * from year_master Order By year_code DESC limit 1";
                        ...
                        if($mo1 != "" || $mo2 != "")
                        {
                          ...
                          $_SESSION["msg"] = "Your child ".strtoupper($name)." is enrolled in AAN (Alumni Association of NCC Cadets) for the training year 2019-20";//.$resss->fetch_assoc()["year_range"];
                          $_SESSION["msg1"] = "Enrollemnt number is ".$enrol." in year of training ".$ty." on basis of his application form ".$form_no." of AAN.";
                        }

                        echo "<script>function data(){var formno = ".(explode("-", $_SESSION["erno"])[3] + 1).";";
                        echo "if(formno > 0 & formno <= 9){ formno = '00' + formno; }";
                  ...
                  <script>Swal.fire({
                    position: 'center',
                    icon: 'warning',
                    title: '".$_SESSION["erno"]." - This Enrollment is already enroll.',
              ...
              if (isset($_POST["btnupdate"])) {
                ...
                if($BDate == "")
                {
                  $queryupdate = "UPDATE enroll_master SET first_name='" . $_POST["cdt_first_name"] . "',last_name='" . $_POST["cdt_last_name"] . "',middle_name='" . $_POST["cdt_middle_name"] . "',std='" . $_POST["cdt_std"] . "',t_year = ".$_POST["t_year"].",form_no='" . $_POST["cdt_form_no"] . "',address='" . $_POST["cdt_add"] . "',city='" . $_POST["cdt_city"] . "',mobile1='" . $_POST["cdt_mo1"] . "',mobile2='" . $_POST["cdt_mo2"] . "',blood_group='" . $_POST["cdt_bgroup"] . "',gender='" . $_POST["cdt_gender"] . "',birthdate=NULL,aadharcard_no='" . $_POST["cdt_aadhar"] . "',atc = ". $atc .",stc = ". $stc .",otc =". $otc ." WHERE enrollment_id='" . $_SESSION["erno"] . "'";
                }
                else
                {
                  $queryupdate = "UPDATE enroll_master SET first_name='" . $_POST["cdt_first_name"] . "',last_name='" . $_POST["cdt_last_name"] . "',middle_name='" . $_POST["cdt_middle_name"] . "',std='" . $_POST["cdt_std"] . "',t_year = ".$_POST["t_year"].",form_no='" . $_POST["cdt_form_no"] . "',address='" . $_POST["cdt_add"] . "',city='" . $_POST["cdt_city"] . "',mobile1='" . $_POST["cdt_mo1"] . "',mobile2='" . $_POST["cdt_mo2"] . "',blood_group='" . $_POST["cdt_bgroup"] . "',gender='" . $_POST["cdt_gender"] . "',birthdate='" . $_POST["cdt_dob"] . "',aadharcard_no='" . $_POST["cdt_aadhar"] . "',atc = ". $atc .",stc = ". $stc .",otc =". $otc ." WHERE enrollment_id='" . $_SESSION["erno"] . "'";
                }

                  if ($con->query($queryupdate) == TRUE) {
                      $sql1 = "insert into activity_log_master(user_id,action_user_id,Status,Date_Time) values(".$_SESSION["ADMIN"].",'".$_SESSION["erno"]."',3,'".date('Y-m-d H:i:s')."')";
                        $con->query($sql1);
                        echo "<script>function data(){var formno = ".(explode("-", $_SESSION["erno"])[3]).";";
                  echo "if(formno > 0 & formno <= 9){ formno = '00' + formno; }";
                  echo "if(formno >= 10 & formno <= 99){ formno = '0' + formno; }";
                  echo "if(formno >= 100 & formno <= 999){ formno = formno; }";
                  echo "document.getElementById('troop_code').value = '".(explode("-", $_SESSION["erno"])[1])."';";
              ...
              if (isset($_POST["btnnext"])) {
                      ...
                      if($row["t_year"] == 5)
                      {
                        ...
                        echo "<script>" . "$('#firstname').val('" . $row["first_name"] . "');" . "$('#middlename').val('" . $row["middle_name"] . "');" . "$('#lastname').val('" . $row["last_name"] . "');"  . "$('#std').val('" . $row["std"] . "');" . "$('#cdt_form_no').val('" . $row["form_no"] . "');" . "$('#cdt_add').val('" . $row["address"] . "');" . "$('#cdt_city').val('" . $row["city"] . "');" . "$('#cdt_mo1').val('" . $row["mobile1"] . "');" . "$('#cdt_mo2').val('" . $row["mobile2"] . "');" . "$('#cdt_bgroup').val('" . $row["blood_group"] . "');" . "$('#cdt_gender').val('" . $row["gender"] . "');" . "$('#cdt_dob').val('" . $row["birthdate"] . "');" . "$('#cdt_aadhar').val('" . $row["aadharcard_no"] . "');" . "$('#btnnext').text('Add To Next Year').attr('name','btnprmote').attr('id','btnprmote').removeAttr('style');
                          $('#newcadet').hide();$('#oldcadet').hide();" . "</script>";
                           ...
                           $('#t_year').attr('disabled',true).val('" . $row["t_year"] . "');
                            $('#stc').attr('readonly',true).val('" . $row["stc"] . "');
                            $('#otc').attr('readonly',true).val('" . $row["otc"] . "');
                            $('#atc').attr('readonly',true).val('" . $row["atc"] . "');
                ...
                else
                {
                  ...
                  <script>Swal.fire({
                    position: 'center',
                    icon: 'warning',
                    title: 'Cadet All Camp Are Finish.',
                    showConfirmButton: false,
                    timer: 1500
                  })</script>";
              ...
              if(isset($_POST["btnprmote"]))
              {
                ...
                if($t_year <= 5 || ($otc == 0 || $otc == 1))
                {
                  if($t_year >= 5)
                  {
                    ...
                    $sql = "update enroll_master set form_no = ". $data .",std = '".$std."',mobile1 = '".$mo1."',mobile2 = '".$mo2."',c_year = ".date("Y").", t_year = '".$t_year."',date_time='".date("y-m-d h:i:s")."' where enrollment_id = '".$_SESSION["erno"]."'";
                      
                      if($t_year == 1)
                      {
                          $sql = "update enroll_master set form_no = ". $data .",std = '".$std."',mobile1 = '".$mo1."',mobile2 = '".$mo2."',c_year = ".date("Y").", t_year = '".$t_year."',atc = 0,stc=0,otc=0,date_time='".date("y-m-d h:i:s")."' where enrollment_id = '".$_SESSION["erno"]."'";
                      }
                      if($t_year == 2)
                      {
                          $sql = "update enroll_master set form_no = ". $data .",std = '".$std."',mobile1 = '".$mo1."',mobile2 = '".$mo2."',c_year = ".date("Y").", t_year = '".$t_year."',atc = 1,stc=0,otc=0,date_time='".date("y-m-d h:i:s")."' where enrollment_id = '".$_SESSION["erno"]."'";
                      }
                      if($t_year == 3)
                      {
                        if($_POST["rdcampyear"] == "ATC")
                        ...
                        if($_POST["rdcampyear"] == "STC")
                        {
                          $sql = "update enroll_master set form_no = ". $data .",std = '".$std."',mobile1 = '".$mo1."',mobile2 = '".$mo2."',c_year = ".date("Y").", t_year = '".$t_year."',atc=0,stc=1,otc=0,date_time='".date("y-m-d h:i:s")."' where enrollment_id = '".$_SESSION["erno"]."'";
                        }
                      }
                      else if($t_year == 4)
                      {
                        ...
                        if($_POST["rdcampyear"] == "OTC")
                        {
                          $sql = "update enroll_master set form_no = ". $data .",std = '".$std."',mobile1 = '".$mo1."',mobile2 = '".$mo2."',c_year = ".date("Y").", t_year = '".$t_year."',atc=0,stc=0,otc=1,date_time='".date("y-m-d h:i:s")."' where enrollment_id = '".$_SESSION["erno"]."'";
                        }
                      }
                      else if($t_year == 5)
                      {
                  ...
                  if($con->query($sql) == TRUE)
                  {
                      $sql1 = "insert into activity_log_master(user_id,action_user_id,Status,Date_Time) values(".$_SESSION["ADMIN"].",'".$_SESSION["erno"]."',2,'".date('Y-m-d H:i:s')."')";
                        $con->query($sql1);
                    $sql23 = "select * from year_master Order By year_code DESC limit 1";
                    $resss = $con->query($sql23);
                    $_SESSION["Send"] = 1;
                ...
                echo "document.getElementById('btnentercadets').click();}</script>";
                  ...
                  <script>Swal.fire({
                    position: 'center',
                    icon: 'success',
                    title: 'Cadet Was Enter In Next Year.',
                    showConfirmButton: false,
                    timer: 1500
                  }); setInterval(data,2000);</script>";
                  }
